 ...
 */
package com.example.ivan.sunshine.data;
...
public class WeatherProvider extends ContentProvider {
    ...
    private Cursor getWeather(Uri uri, String selection, String[] selectionArgs, String[] projection, String sortOrder){
        SQLiteDatabase db = mOpenHelper.getReadableDatabase();
        return db.query(WeatherContract.WeatherEntry.TABLE_NAME,projection,selection,selectionArgs,null,null,sortOrder);
    }

    private Cursor getLocation(Uri uri, String selection, String[] selectionArgs, String[] projection, String sortOrder){
        SQLiteDatabase db = mOpenHelper.getReadableDatabase();
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (sUriMatcher.match(uri)) {
            ...
            // "weather"
            case WEATHER: {
                retCursor = getWeather(uri,selection, selectionArgs, projection,sortOrder);
                break;
            }
            // "location"
            case LOCATION: {
                retCursor = getLocation(uri,selection,selectionArgs,projection,sortOrder);
                break;
            }
